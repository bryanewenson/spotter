...
class Data:
	...
	__section_mapping = {'start': 0, 'duration': 1, 'confidence': 2, 'loudness': 3, 'tempo': 4, 'tempo_confidence': 5, 'key': 6, 'key_confidence': 7, 'mode': 8, 'mode_confidence': 9, 'time_signature': 10, 'time_signature_confidence': 11}

	__segment_mapping = {'start': 0, 'duration': 1, 'confidence': 2, 'loudness_start': 3, 'loudness_max_time': 4, 'loudness_max': 5, 'loudness': 6, 'pitches': 7, 'timbre': 8}
	...
	def get_track_data(self, Spot, tid):
		...
		for label in self.__section_mapping.keys():
			section_data[label] = tmp[self.__section_mapping[label]]
		...
		for label in self.__segment_mapping.keys():
			segment_data[label] = tmp[self.__segment_mapping[label]]
